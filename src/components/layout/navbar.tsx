          ...
          <div className="container mx-auto flex flex-wrap items-center justify-between ">
            ...
            <div className="hidden md:block w-full md:w-auto " id="mobile-menu">
              <ul className="flex-col md:flex-row flex md:space-x-8 mt-4 md:mt-0 md:text-lg md:font-medium">
                <li>
                  <Link
                    className="hover:bg-gray-50 border-b md:hover:bg-transparent md:border-0 block pl-3 pr-4 py-2 md:hover:text-gray-300 md:p-0"
                    href="/"
                  >
                    Home
                  </Link>
                ...
                <li>
                  <button
                    ...
                    className=" hover:bg-gray-50 border-b border-gray-100 md:hover:bg-transparent md:border-0 pl-3 pr-4 py-2 md:hover:text-gray-300 md:p-0 font-medium flex items-center justify-between w-full md:w-auto"
                  >
                    Services{" "}
                    <svg
